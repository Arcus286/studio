          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
              ...
              <div className="relative">
                ...
                />
                 <Card className="absolute -bottom-4 left-8 w-48 shadow-lg bg-background/80 backdrop-blur-sm">
                ...
                <Card className="absolute -top-4 right-8 w-48 shadow-lg bg-background/80 backdrop-blur-sm">
                    <CardContent className="p-4">
